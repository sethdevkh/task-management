...
Login is **live** (`POST /api/auth/login`). Task / standup / dashboard data is still mocked. There are no frontend secrets. See [docs/frontend.md](../docs/frontend.md) and [docs/api.md](../docs/api.md).
