...
Every other `/api/**` path returns `401` without a valid `Authorization: Bearer` token. Task, standup, and dashboard endpoints are documented in [`docs/api.md`](../docs/api.md).
